...
<div
    ...
    <div class="flex h-12 items-center justify-center text-2xl text-[#8590AD] transition duration-300 group-focus-within:text-[#ef5b97]">
        @if (isset($icon))
            {{ $icon }}
        @endif
    </div>
    ...
    <div class="relative h-12">
        <input type="{{ $type }}" placeholder=" "
            class="auth-input peer absolute left-0 top-0 h-full w-full appearance-none border-none bg-transparent px-3 pb-1 pt-5 text-[1.2rem] text-[#ef5b97] outline-none ring-0 focus:border-none focus:outline-none focus:ring-0 focus:shadow-none">
        <label for=""
